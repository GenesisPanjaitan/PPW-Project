...
@section('content')
                            ...
                            <form action="{{ route('register.submit') }}" method="POST">
                                    ...
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            ...
                                            @if(session('info'))
                                                {{ session('info') }}
                                            @else
                                                Anda login dengan {{ ucfirst(Auth::user()->login_method ?? 'akun') }} ({{ Auth::user()->email ?? 'akun Anda' }}). Lengkapi data di bawah untuk melanjutkan.
                                            @endif
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-custom" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" value="{{ old('nim') }}" required>
                                ...
                                <h5 class="fw-bold mb-3 fs-6">Informasi Karir</h5>
                                <div class="row g-3">
                                    <div class="col-md-12">
    ...
    @error('interest') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control form-control-custom" id="skill" name="skill" placeholder="Contoh: Java, Python, React, Figma, Excel, CSS" value="{{ old('skill') }}">
